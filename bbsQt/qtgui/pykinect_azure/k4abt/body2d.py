...
from ._k4abtTypes import K4ABT_JOINT_COUNT, K4ABT_SEGMENT_PAIRS
from ._k4abtTypes import k4abt_skeleton2D_t, k4abt_body2D_t, body_colors
...
class Body2d:
	...
	def draw(self, image, only_segments = False):
		...
		for joint in self.joints:
			...
			#print(joint.get_coordinates())
		return image

	def joint(self, image, only_segments = False):
		joint_list = []

		for joint in self.joints:
			joint_list.append([joint.get_name()] + list(joint.get_coordinates()))
